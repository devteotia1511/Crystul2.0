...
function RegisterPage() {
    ...
    const handleGoogleSignUp = async ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Google sign-up failed. Please try again.");
        } finally{
    ...
    const handleSubmit = async (e)=>{
        ...
        if (formData.password.length < 6) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Password must be at least 6 characters long");
            return;
        }
        try {
            setIsLoading(true);
            ...
            if (data.success) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(data.message || "Registration failed. Please try again.");
            }
        } catch (error) {
...
_s(RegisterPage, "MiDCt0TESk4q3htMW/FNi5rX0Ds=", false, function() {
    return [
...
//# sourceMappingURL=_d40dfe83._.js.map